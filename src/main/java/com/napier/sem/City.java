    ...
    public ArrayList<City> getCities(String category, String name)
    {
        ...
        if (category == "inWorld" && name == null)
        {
            ...
            catch (Exception e)
            {
                ...
                System.out.println("Failed to get details of all the cities in the world");
                return null;
            }
        }
        ...
        if (category == "inContinent" && name != null)
        {
            ...
            {
                System.out.println(e.getMessage());
                System.out.println("Failed to get details of all the cities in this continent");
                return null;
            }
        }
        //To get all the cities in a particular region
        if (category == "inRegion" && name != null) {
            try {
                ...
                System.out.println(e.getMessage());
                System.out.println("Failed to get details of all the cities in this region");
                return null;
            }
        }
        //To get all the cities in a particular country
        if (category == "inCountry" && name != null) {
            try {
                // Create SQL statement
                Statement stmt = App.con.createStatement();
                ...
                System.out.println(e.getMessage());
                System.out.println("Failed to get details of all the cities in this country");
                return null;
            }
        }
        return null;
